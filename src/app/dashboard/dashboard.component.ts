...
import { DadosService } from './dados.service'; //importando os dados para pegar os grafico

//variavel do escopo global
   ...
   */
   init(): void {
    if(typeof(google) !== 'undefined') {
      google.charts.load('current', {'packages':['corechart']});
      setTimeout(() => { //tempo add de 1 segundo para o carregamento do gráfico
